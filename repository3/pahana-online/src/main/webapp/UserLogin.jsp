...
<div class="card login-card p-3 p-md-4">
  <div class="card-body">
    <div class="text-center mb-3">
      <h3 class="brand">Pahana Edu — User</h3>
      <p class="text-muted small mb-0">Sign in to Buy Products</p>
    </div>
    ...
    <div class="text-center mt-3">
      <a href="Store.jsp" class="small text-decoration-none">← Back to Home</a>
    </div>
  </div>
</div>
